...
rent1 <- ggplot(data = apart2016) +
  aes(x = Rent_Average, y = log(Price_Ave)) +
  geom_point() +
  geom_smooth(method = lm, color = "red") +
  theme_minimal() + 
  labs(title = "Apartment Average Rent vs. Price per Neighborhood") +
  xlab("Average Rent") +
...
rent2 <- ggplot(data = private2016) +
  ...
  geom_smooth(method = lm, color = "red") +
  theme_minimal() + 
  labs(title = "Private Average Rent vs. Price per Neighborhood") +
  xlab("Average Rent") +
  ylab("Log Average Price")
...
rent3 <- ggplot(data = shared2016) +
  ...
  geom_smooth(method = lm, color = "red") +
  theme_minimal() + 
  labs(title = "Shared Average Rent vs. Price per Neighborhood") +
  xlab("Average Rent") +
  ylab("Log Average Price")
...
accom1 <- ggplot(data = apart2016) +
  aes(x = Accomm_Ave, y = log(Price_Ave)) +
  geom_point() +
  geom_smooth(method = lm, color = "red") +
  theme_minimal() +
  labs(title = "Apartment Average Accommodation vs. Price per Neighborhood") +
  xlab("Average Accommodation") +
  ylab("Log Average Price")
...
accom2 <- ggplot(data = private2016) +
  ...
  geom_smooth(method = lm, color = "red") +
  theme_minimal() +
  labs(title = "Private Average Accommodation vs. Price per Neighborhood") +
  xlab("Average Accommodation") +
  ylab("Log Average Price")
...
accom3 <- ggplot(data = shared2016) +
  ...
  geom_smooth(method = lm, color = "red") +
  theme_minimal() +
  labs(title = "Shared Average Accommodation vs. Price per Neighborhood") +
  xlab("Average Accommodation") +
  ylab("Log Average Price")
...
```{r, echo = FALSE}
ggarrange(rent1, rent2, rent3, ncol=1, nrow = 3)
```
...
```{r, initial linear regression, include = FALSE}
...
```{r, retest linear models, include = FALSE}
...
```{r, echo = FALSE}
kable(R2_2, caption = "No Outlier R-Squared Values")
```
