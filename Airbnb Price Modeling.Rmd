...
Table 1 is a chart of the R-squared values for the raw data.
...
```{r, predictions 2014/2017, include = FALSE}
## Linear Regression
...
```{r, echo = FALSE}
figure <- ggarrange(pred17_1, pred17_2, pred17_3, ncol=3, nrow = 1, common.legend = TRUE, legend="right")
